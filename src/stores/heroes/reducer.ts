...
const index: Reducer<HeroesState["index"]> = (
...
const data: Reducer<HeroesState["data"]> = (
...
const errors: Reducer<HeroesState["errors"]> = (
...
const loading: Reducer<HeroesState["loading"]> = (
